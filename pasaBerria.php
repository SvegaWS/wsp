...
<head>
	...
	<link rel="stylesheet" type="text/css" href="stylesPWS/login.css">
		...
		function atzerajoan(){
		window.location = "http://localhost/LAB1/berreskuratuPass.php";
...
<body onload="myFunction()" background="images/body.jpg">
<div class="goi"></div>
...
<form name="pasahitzaberria" method="post" action="pasaBerria.php" onSubmit="return balidatu();" >
				 ...
				 <input class="btn" type="button" value="Atzera" name="Atzera" onclick="atzerajoan();">
				 <br>
</form>
